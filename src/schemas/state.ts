...
import { citySelectable, PuRelCity, RCity } from "./city.ts";
import { CountryInp, ICountry, PuRelCountry, RCountry } from "./country.ts";
import { countrySelectable, ICity } from "./mod.ts";
    ...
    checkRelation(depth, "state") &&
      (pureObj = {
        ...
        cities: {
          type: "object",
          optional: true,
          props: citySelectable(depth.state),
        },
      });
